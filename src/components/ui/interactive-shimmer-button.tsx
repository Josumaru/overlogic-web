  ...
  (
    ...
    return (
      ...
      >
        ...
        {/* Button text */}
        <span className="inline-block translate-x-1 dark:text-background group-hover:text-background transition-all duration-300 group-hover:translate-x-12 group-hover:opacity-0">
          {text}
        </span>
