  ...
  return (
    <div className="mx-auto w-screen">
      ...
      <div className="text-text-title-color">
        <MorphingText
          texts={[dict.home.headerTitleFull, dict.home.headerTitleFull2]}
        />
      </div>

      {/* Desc */}
      <h2 className="text-text-headline-color md:mt-[8.2rem] mt-[10rem] text-center md:text-[1.5rem] text-[1rem] md:w-3/6 w-5/6 mx-auto md:space-x-3 space-x-1">
      ...
      <div className="flex flex-col justify-center items-center mt-[4rem] ">
        <h3 className="md:font-extrabold font-bold md:text-2xl text-sm">
          {dict.home.trustedByLeadingTeam}
        </h3>
            ...
            {teams.map((data, index) => {
              ...
              return (
                <Image
                  ...
                  width={170}
                  height={1000}
                  className="md:mx-4 mx-1 aspect-auto object-contain brightness-[0] opacity-60 dark:invert"
                />
              );
            })}
          </Marquee>
